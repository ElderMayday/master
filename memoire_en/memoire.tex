...
\item \textbf{Parser} - abstract problem instance parsing. Depends on the problem type. Also a problem instance may have different formats of representation.
...
[Class diagram is too large to add here. Put in appendix?]
