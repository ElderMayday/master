...
public class TestRankBasedAntSystem
{
    ...
    public void testRankBasedAntSystem()
    {
        ...
        try
        {
            ...
            assertEquals(structure2d.get(0, 0).getPheromone(), 0.4, 0.0001);
            assertEquals(structure2d.get(0, 1).getPheromone(), 0.4, 0.0001);
            assertEquals(structure2d.get(0, 2).getPheromone(), 0.4, 0.0001);
            assertEquals(structure2d.get(0, 3).getPheromone(), 0.4, 0.0001);

            update.update(solutionList);

            assertEquals(structure2d.get(0, 0).getPheromone(), 0.36, 0.0001);
            assertEquals(structure2d.get(0, 1).getPheromone(), 0.40, 0.0001);
            assertEquals(structure2d.get(0, 2).getPheromone(), 0.36, 0.0001);
            assertEquals(structure2d.get(0, 3).getPheromone(), 0.36, 0.0001);
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public void testRankBasedAntSystem_wIsLessThanSolutionNumber()
    {
        ...
        try
        {
            ...
            GlobalUpdate update = new RankBasedAntSystem(problem, 0.9, 1, true, 0.5);

            update.update(solutionList);

            assertEquals(structure2d.get(0, 0).getPheromone(), 0.0667, 0.0001);
            assertEquals(structure2d.get(0, 1).getPheromone(), 0.0667, 0.0001);
            assertEquals(structure2d.get(0, 2).getPheromone(), 0.0667, 0.0001);
            assertEquals(structure2d.get(0, 3).getPheromone(), 0.0667, 0.0001);

            update.update(solutionList);

            assertEquals(structure2d.get(0, 0).getPheromone(), 0.0600, 0.0001);
            assertEquals(structure2d.get(0, 1).getPheromone(), 0.0667, 0.0001);
            assertEquals(structure2d.get(0, 2).getPheromone(), 0.0600, 0.0001);
            assertEquals(structure2d.get(0, 3).getPheromone(), 0.0600, 0.0001);
        }
        catch (Exception e)
        {
            e.printStackTrace();
