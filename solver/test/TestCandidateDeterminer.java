...
{
    @Test
    public void testCandidateDeterminerVrpSorting_normal()
    {
    ...
    /**
     * Tests CandidateDeterminerVrpSorting when the number of desired candidate edges per node is larger than the total number of nodes
     */
    @Test
    public void testCandidateDeterminerVrpSorting_exceed()
    {
        ProblemVRP problem = null;
        ...
        assertEquals(list0.get(0).intValue(), 1);
        assertEquals(list0.get(1).intValue(), 3);
        assertEquals(list0.get(2).intValue(), 2);
